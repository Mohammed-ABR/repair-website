...
const buttonEase =
  "transform-gpu transition-[transform,background-color,box-shadow,border-color,filter,opacity] duration-200 ease-out select-none motion-reduce:transition-none";

/** Core hover for primary/secondary CTAs (CSS; use with Link or <a>) */
const buttonInteractive = `${buttonEase} hover:scale-[1.02] active:scale-[0.99] motion-reduce:hover:scale-100 motion-reduce:active:scale-100`;
...
export const interactiveIcon = `${buttonEase} hover:scale-[1.02] active:scale-[0.98] motion-reduce:hover:scale-100 motion-reduce:active:scale-100`;
...
export const buttonPrimaryMotion =
  "inline-flex items-center justify-center rounded-2xl border border-transparent bg-accent px-6 py-3.5 text-sm font-semibold text-white shadow-soft-md transform-gpu transition-[transform,box-shadow,background-color] duration-200 ease-out hover:bg-accent-secondary hover:shadow-soft-lg active:bg-accent-secondary motion-reduce:transition-none motion-reduce:hover:bg-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/45 focus-visible:ring-offset-2";

export const buttonSecondaryMotion =
  "inline-flex items-center justify-center rounded-2xl border border-transparent bg-accent px-6 py-3.5 text-sm font-semibold text-white shadow-soft-md transform-gpu transition-[transform,box-shadow,background-color] duration-200 ease-out hover:bg-accent-secondary hover:shadow-soft-lg active:bg-accent-secondary motion-reduce:transition-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/45 focus-visible:ring-offset-2";
